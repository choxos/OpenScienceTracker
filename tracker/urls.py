...
urlpatterns = [
    ...
    path('ajax/fields/', views.ResearchFieldListView.as_view(template_name='tracker/partials/field_list_content.html'), name='ajax_field_list'),
    path('ajax/fields/<int:pk>/', views.ResearchFieldDetailView.as_view(template_name='tracker/partials/field_detail_content.html'), name='ajax_field_detail'),
